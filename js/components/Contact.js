export default function Resume() {
    ...
    <div class="text-gray-100 px-8 py-12">
        <div
            class="max-w-screen-xl px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gradient-to-r from-cyan-100 to-blue-100 text-gray-900 rounded-lg shadow-lg">
            <div class="flex flex-col justify-between">
                <div>
                    <h2 class="text-4xl lg:text-5xl font-bold leading-tight">Lets talk about everything!</h2>
                    <div class="text-gray-700 mt-8">
                        Hate forms? Send us an <span class="underline"><a href="mailto:madisonrmitchell@icloud.com">email</a></span> instead.
                    </div>
                </div>
                    ...
                    <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <g opacity="0.1">
                            ...
                            <path
                                ...
                                transform="translate(-52 -162.63)" fill="#0ea5e9" />
                            <path
                        ...
                        <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#0ea5e9" opacity="0.1" />
                        <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#0ea5e9" opacity="0.1" />
                        <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#0ea5e9" opacity="0.1" />
                        <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#0ea5e9" opacity="0.1" />
                        <path
                            ...
                            transform="translate(-52 -162.63)" fill="#0ea5e9" opacity="0.1" />
                        <path
            ...
            <form action="mailto:madisonrmitchell@icloud.com" method=”POST” enctype=”multipart/form-data” name=”EmailForm”>
                <div class="">
                    <div>
                        <span class="uppercase text-sm text-gray-600 font-bold">Full Name</span>
                        <input
                            class="w-full bg-transparent text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline focus:border-sky-500"
                    ...
                    <div class="mt-8">
                        ...
                        <textarea
                            class="w-full h-32 bg-transparent text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline focus:border-sky-500"></textarea>
                    </div>
                    <div class="mt-8">
                        <button
                            class="uppercase text-sm font-bold tracking-wide bg-sky-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline hover:bg-sky-600 active:bg-sky-700" type="submit" value="Send">
                            Send Message
                        </button>
                    </div>
                </div>
