...
export default function Projects() {
    return `
    <div id="ohioansCare" class="project header-wrapper border-solid border-2 border-cyan-500 rounded-3xl my-5 animate__animated animate__bounceInDown bg-gradient-to-r from-cyan-600 to-blue-600 cursor-pointer">
        <div class="project-container-left rounded-3xl">
            ...
            <div class="header-grid m-auto flex flex-col">
                <div class="header justify-center flex  mx-6">
                    ...
                    <div class="title text-center p-3 text-sky-50 font-cursive leading-10">
                        Ohioans Care
                    </div>
                ...
                <div class="header justify-center flex  mx-6">
                    ...
                    <div class="sub-heading-2 text-justify tracking-wider font-mono p-3 text-sky-100">
    ...
    <div id="mysteryEducator" class="project header-wrapper border-solid border-2 border-blue-500 rounded-3xl my-5 animate__animated animate__bounceInDown animate__delay-1s bg-gradient-to-r from-cyan-600 to-blue-600">
        <div class="project-container-right rounded-3xl">
            <div class="header-grid m-auto flex flex-col">
                <div class="header justify-center flex  mx-6">
                    <span class="html-text align-left align-top text-sky-300">&lt;header&gt;</span>
                    <div class="title text-center p-3 text-sky-50 font-cursive leading-10">
                    <span class="html-text align-left align-top text-sky-300">JAC's</span><br>
                        Mystery Educator
                    </div>
                    <span class="html-text align-right align-bottom text-sky-300">&lt;/header&gt;</span>
                </div>
                ...
                <div class="header justify-center flex mx-6">
                    <span class="html-text align-left align-top text-sky-300">&lt;h1&gt;</span>
                    <div class="sub-heading-2 text-justify p-3 text-sky-100 font-mono">
    ...
    <div id="islandHopping" class="project header-wrapper border-solid border-2 border-cyan-500 rounded-3xl my-5 animate__animated animate__bounceInDown animate__delay-2s bg-gradient-to-r from-cyan-600 to-blue-600">
        <div class="project-container-left rounded-3xl">
